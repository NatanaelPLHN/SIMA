...
<div>
    ...
    <input type="text" id="nama" name="nama" pattern="[A-Z a-z0-9,.]{0,30}" minlength="4" maxlength="20"
...
<div>
    ...
    <input type="text" id="lokasi" name="lokasi" pattern="[A-Z a-z0-9,.]{0,30}" minlength="4" maxlength="30"
