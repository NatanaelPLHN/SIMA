...
<div
        ...
        <div class="w-full mb-1">
            {{-- <h1 class="text-lg font-semibold text-indigo-800 dark:text-indigo-400">Tambah Bidang</h1> --}}
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Tambah Bidang</h1>
            </div>
            <div class="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg p-6">
                <form action="{{ routeForRole('departement', 'store') }}" method="POST" enctype="multipart/form-data"
