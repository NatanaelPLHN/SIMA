...
<div
        ...
        <div class="w-full mb-1">
            {{-- <h1 class="text-lg font-semibold text-indigo-800 dark:text-indigo-400">Tambah Akun</h1> --}}
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Tambah Akun</h1>
            </div>
