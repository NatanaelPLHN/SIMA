                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white">
                            @foreach ($usagesBergerak as $index => $asset)
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center justify-center gap-x-3">
                                            ...
                                            <a class="fas fa-eye text-blue-600 hover:text-blue-800"
                                                href="{{ routeForRole('asset-usage', 'show', $asset->id) }}"></a>
                                            <!-- Edit -->
                                            <a class="fas fa-edit text-yellow-600 hover:text-yellow-800"
                                                href="{{ routeForRole('asset-usage', 'edit', $asset->id) }}"></a>
                                            <!-- Delete -->
                                            <form method="POST"
                                                action="{{ routeForRole('asset-usage', 'destroy', $asset->id) }}"
                                                class="delete-form">
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white">
                            @foreach ($usagesTidakBergerak as $index => $asset)
                                <tr>
                                    <td class="text-center">{{ $index + 1 }}</td>
                                    <td class="px-4 py-3 text-sm text-center text-gray-900 whitespace-normal break-words">
                                        {{ $asset->kode }}</td>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 bg-indigo-800">
                        ...
                        <tbody class="bg-white">
                            @foreach ($usagesHabisPakai as $index => $asset)
                                <tr>
                                    <td class="text-center">{{ $index + 1 }}</td>
                                    <td class="px-4 py-3 text-sm text-center text-gray-900 whitespace-normal break-words">
                                        {{ $asset->kode }}</td>
