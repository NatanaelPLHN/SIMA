                            ...
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-900">
                                    <span
                                        ...
                                        @if ($session->status == 'selesai') bg-green-100 text-green-800 @endif
                                        @if ($session->status == 'proses') bg-yellow-100 text-yellow-800 @endif
                                        @if ($session->status == 'dijadwalkan') bg-red-100 text-red-800 @endif">
