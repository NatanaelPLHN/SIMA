...
<div>
    ...
    <input type="text" id="nama" name="nama" pattern="[A-Za-z0-9.,]{0,30}" placeholder="Masukkan nama instansi..."
        minlength="6" maxlength="30" title="Only letters and numbers allowed"
...
<div>
    ...
    <input type="text" id="alias" name="alias" pattern="[A-Za-z0-9.,-]{0,30}"
        placeholder="Masukkan alias instansi..." minlength="3" maxlength="30" title="Only letters and numbers allowed"
...
<div>
    <label for="pemerintah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pemerintah <span
            class="text-red-500">*</span></label>
    <input type="text" id="pemerintah" name="pemerintah" pattern="[A-Za-z0-9,.-]{0,30}"
        placeholder="Masukkan nama pemerintah..." minlength="6" maxlength="30" title="Only letters and numbers allowed"
...
<div>
    ...
    <input type="tel" id="telepon" name="telepon" pattern="[0-9]{0,20}"
        placeholder="Masukkan nomor telepon instansi..." minlength="10" maxlength="20" title="Only numbers allowed"
...
<div>
    ...
    <input type="text" id="alamat" name="alamat" pattern="[A-Za-z0-9,.-]{0,30}"
        placeholder="Masukkan alamat instansi..." minlength="6" maxlength="30" title="Only letters and numbers allowed"
...
<div>
    ...
    @if ($employees->isNotEmpty())
        ...
        <select name="kepala_instansi_id" id="kepala_instansi_id"
            ...
            <option value="">Pilih Kepala Institusi</option>
    ...
    @if (isset($institution) && $institution->exists)
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Hanya menampilkan pegawai yang ada di institusi ini.
        </p>
    @else
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Kepala institusi dapat dipilih setelah institusi dibuat dan pegawai ditambahkan.
        </p>
    @endif
