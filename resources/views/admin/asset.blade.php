    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex space-x-1 bg-white rounded-lg shadow-sm">
                <button class="px-4 py-2 text-sm font-medium text-white bg-indigo-800 rounded-lg">
                    Bergerak
                </button>
                <button
                    class="px-4 py-2 text-sm font-medium text-indigo-800 hover:text-indigo-900 hover:bg-indigo-100 rounded-lg">
                    Tidak Bergerak
                </button>
                <button
                    class="px-4 py-2 text-sm font-medium text-indigo-800 hover:text-indigo-900 hover:bg-indigo-100 rounded-lg">
