    ...
    <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6">
        <form class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                {{-- bergerak --}}
                <div>
                    <label for="merk" class="block text-sm font-medium text-gray-700 mb-1">Ukuran</label>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="type" class="block text-sm font-medium text-gray-700 mb-1">Bahan</label>
