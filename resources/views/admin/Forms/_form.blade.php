...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <input type="text" id="group_kategori" name="group_kategori" value="{{ old('group_kategori') }}"
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <input type="number" id="nilai_pembelian" name="nilai_pembelian" value="{{ old('nilai_pembelian') }}" min="0" step="0.01"
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <input type="date" id="tgl_pembelian" name="tgl_pembelian" value="{{ old('tgl_pembelian') }}" max="<?php echo date('Y-m-d'); ?>"
...
<div>
    ...
    <input type="text" id="lokasi_terakhir" name="lokasi_terakhir" value="{{ old('lokasi_terakhir') }}"
