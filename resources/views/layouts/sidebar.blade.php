            ...
            @if(auth()->user()->role == 'superadmin')
                ...
                <li>
                    ...
                    <ul x-show="masterOpen" x-transition class="ml-6 mt-1 space-y-1">
                        <li><a href="{{ route('instansi.index') }}"
                                class="block px-2 py-1 hover:text-indigo-200">Instansi</a></li>
                        <li><a href="{{ route('bidang.index') }}" class="block px-2 py-1 hover:text-indigo-200">Bidang</a>
                        </li>
                        ...
                        <li><a href="#" class="block px-2 py-1 hover:text-indigo-200">Grup Kategori</a></li>
                        <li><a href="#" class="block px-2 py-1 hover:text-indigo-200">Aset</a></li>
                    </ul>
                </li>
