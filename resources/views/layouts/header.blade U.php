<nav class="fixed z-30 w-full bg-white border-b-2 border-gray-300 dark:bg-gray-800 dark:border-gray-700">
    ...
    <!-- Close -->
    <svg id="sidebarIconClose" class="hidden w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
    ...
    <a href="#" class="flex ml-2 md:mr-24">
        ...
        <span
            class="self-center ml-2 text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
            SIM ASET
        </span>
    </a>
</div>
