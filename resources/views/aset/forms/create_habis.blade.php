...
@section('title', 'Create Habis Pakai')
    ...
    <div
        ...
        <div class="w-full mb-1">
            ...
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Tambah Aset Habis Pakai</h1>
            </div>
            <div class="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg p-6">
                <form action="{{ routeForRole('assets', 'store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <!-- Form Groups -->
                    @include('aset.forms._form', ['jenis_aset' => 'habis_pakai'])
                    <input type="hidden" name="jenis_aset" value="habis_pakai">

                    {{-- <div class="grid grid-cols-1 md:grid-cols-2 gap-4"> --}}
                    <div>
                        <label for="register"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-100 mb-1">Register</label>
                        <input type="text" id="register" name="register" pattern="[A-Z a-z0-9,.]{0,30}"
                            placeholder="Masukkan register aset..." minlength="4" maxlength="30"
                    ...
                    <div>
                        <label for="satuan"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-100 mb-1">Satuan</label>
                        <input type="text" id="satuan" name="satuan" pattern="[A-Z a-z0-9,.]{0,30}"
                            placeholder="Masukkan satuan aset..." minlength="4" maxlength="30"
                            title="Only letters, numbers, and spaces allowed"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    {{-- </div> --}}
