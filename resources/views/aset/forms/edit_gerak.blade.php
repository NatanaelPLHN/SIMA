    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Edit Aset Bergerak</h1>
            </div>
                    ...
                    @include('aset.forms._form')
                        ...
                        <div>
                            ...
                            <input type="text" id="nomor_serial" name="nomor_serial"
                                value="{{ old('nomor_serial', $asset->bergerak->nomor_serial ?? '') }}"@readonly(true)
