...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Aset Tidak Bergerak</h1>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block dark:text-gray-100 text-sm font-medium text-gray-700 mb-1">
                                        Ukuran:</label>
                                    <div
                                        class="px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                ...
                                <div>
                                    <label class="block dark:text-gray-100 text-sm font-medium text-gray-700 mb-1">Tahun
                                        Bahan:</label>
                                    <div
                                        class="px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                        ...
                        <div class="space-y-6">
                            <div class="flex justify-center">
                                <div class="bg-white dark:bg-white p-4 rounded-lg">
                                    <img src="{{ asset('storage/' . $asset->tidakBergerak->qr_code_path) }}" alt="QR Code"
                                        class="w-48 h-48 sm:w-48 sm:h-48 object-contain">
                                </div>
                            </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg mt-8 p-6">
        ...
        <div class="flex justify-end mt-4">
            <a href="{{ routeForRole('asset', 'export', $asset->id) }}" {{-- <a href="{{ route('subadmin.asset.export', $asset->id) }}" --}}
