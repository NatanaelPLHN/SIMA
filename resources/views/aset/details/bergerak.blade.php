    ...
    <div
        ...
        <div class="w-full mb-1">
            ...
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Aset Bergerak</h1>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label
                                        class="block text-sm dark:text-gray-100 font-medium text-gray-700 mb-1">Merk:</label>
                                    <div
                                        class="px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                        {{ $asset->bergerak->merk ?? '?' }}
                                    </div>
                                ...
                                <div>
                                    <label
                                        class="block dark:text-gray-100 text-sm font-medium text-gray-700 mb-1">Type:</label>
                                    <div
                                        class="px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
                                        {{ $asset->bergerak->tipe ?? '?' }}
                                    </div>
                                ...
                                <div>
                                    <label class="block dark:text-gray-100 text-sm font-medium text-gray-700 mb-1">Serial
                                        Number:</label>
                                    <div
                                        class="px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">
