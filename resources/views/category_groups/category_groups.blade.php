                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($categoryGroups as $index => $categoryGroup)
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm text-gray-900">{{ $categoryGroup->nama }}</td>
                            <td class="px-4 py-3 text-sm text-gray-900">{{ $categoryGroup->deskripsi }}</td>
                    ...
                    html: `
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="alias" name="alias" value="${categoryGroup.alias || ''}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                    placeholder="Contoh: elektronik, kendaraan">
